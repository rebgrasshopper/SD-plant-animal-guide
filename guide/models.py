...
class Plant(models.Model):
    ...
    image_whole = models.CharField(max_length=2090, default=None, blank=True, null=True)
    image_whole_title = models.CharField(max_length=400, default=None, blank=True, null=True)
    image_leaf = models.CharField(max_length=2090, default=None, blank=True, null=True)
    image_leaf_title = models.CharField(max_length=400, default=None, blank=True, null=True)
    image_flower = models.CharField(max_length=2090, default=None, blank=True, null=True)
    image_flower_title = models.CharField(max_length=400, default=None, blank=True, null=True)
    image_fruit = models.CharField(max_length=2090, default=None, blank=True, null=True)
    image_fruit_title = models.CharField(max_length=400, default=None, blank=True, null=True)
    image_alternate1 = models.CharField(max_length=2090, default=None, blank=True, null=True)
    image_alternate1_title = models.CharField(max_length=400, default=None, blank=True, null=True)
    image_alternate2 = models.CharField(max_length=2090, default=None, blank=True, null=True)
